...
# ボタンの作成
button_1 = Button(root, text='お知らせ', command=show_message)
button_2 = Button(root, text='エラー', command=show_error)
button_3 = Button(root, text='警告', command=show_warning)
button_4 = Button(root, text='yesno質問', command=ask_yesno)
button_5 = Button(root, text='質問', command=ask_question)
button_6 = Button(root, text='キャンセル質問', command=ask_cancel)
button_7 = Button(root, text='リトライ質問', command=ask_retry)
